...
for i in range(5):
    km = KMeansClustering(K=12, max_iters=15, dataset_name="VertebralColumn")
    X_final, y_final = km.fit(X, y)
    print "Vertebral Column"
