...
# Code for svm train and k fold validation
# classifier_dict = {}
# num_folds = 5
# mean_acc = 0
...
#                 y_temp.append(1)
#
#         classifier_dict[label] = svm.SVC(kernel='linear')
...
plt.savefig('ConfusionMatricesAndROC/data5_confusionmatrix_linearKernel')
# Plot normalized confusion matrix
plt.figure()
plot_confusion_matrix(cnf_matrix, classes=unique_classes_list, normalize=True,
                      title='Normalized confusion matrix')
plt.savefig('ConfusionMatricesAndROC/data5_normalizedconfusionmatrix_linearKernel')
plt.show()
