...
if __name__ == "__main__":
	...
	nn = MLPClassifier(hidden_layer_sizes=(100,100),activation="logistic",solver="adam",max_iter=1000,alpha=0.01,verbose=1)
	...
	plot_confusion_matrix(cm1,classes, title = "TE-Using Doc2vec Neural Network")
